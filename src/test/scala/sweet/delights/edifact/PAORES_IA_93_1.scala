...
case class PAORES_IA_93_1(
  ...
  messageEntry: Option[Segment_S_2],
  freeflowText: List[Segment_S_1],
  errorOrWarningSection: List[Group_G_1],
  singleCityPairInfo: List[Group_G_2]
) {
  def isEmpty: Boolean =
    unb.isEmpty &&
      ung.isEmpty &&
...
case class Group_G_1(
  errorOrWarningInfo: Segment_S_3,
  textInformation: Option[Segment_S_1]
)

case class Group_G_2(
  boardoff: Segment_S_4,
  flightInfo: List[Group_G_3]
)

case class Group_G_3(
  basicFlightInfo: Segment_S_8,
  infoOnClass: Option[Segment_S_6],
  flightDetails: Option[Segment_S_5],
  flightFreeflowText: Option[Segment_S_1],
  trafficRestrictionDetails: Option[Segment_S_7],
  flightErrorWarningSection: List[Group_G_4]
)

case class Group_G_4(
  flightErrorWarningInfo: Segment_S_3,
  flightErrorWarningText: Option[Segment_S_1]
)
...
case class Segment_S_5(
  flightDetails: Option[Composite_C_4],
  departureStation: Option[Composite_C_8],
  arrivalStation: Option[Composite_C_8],
  travellerTimeDetails: Option[Composite_C_6],
  productFacilities: List[Composite_C_7]
) {
  def isEmpty: Boolean =
...
case class Segment_S_3(
  error: Composite_C_3
)

case class Segment_S_1(
  freeTextQualification: Option[Composite_C_1],
...
case class Segment_S_2(
  functionDetails: Composite_C_2,
  responseType: Option[String]
)

case class Segment_S_4(
...
case class Segment_S_6(
  productClassDetail: List[Composite_C_9]
) {
  def isEmpty: Boolean =
    productClassDetail.isEmpty
}

case class Segment_S_7(
  trafficRestriction: List[Composite_C_10]
) {
  def isEmpty: Boolean =
    trafficRestriction.isEmpty
}

case class Segment_S_8(
  flightDate: Composite_C_14,
  boardPointDetails: Composite_C_15,
  offPointDetails: Composite_C_15,
  companyDetails: Option[Composite_C_11],
  flightIdentification: Composite_C_12,
  flightTypeDetails: Option[Composite_C_13],
...
object Composite_C_5

case class Composite_C_6(
...
case class Composite_C_15(
  trueLocationId: String
)

case class Composite_C_10(
  code: Option[String]
) {
  def isEmpty: Boolean =
    code.isEmpty
...
abstract class EdifactParser extends BytesParsers {
  ...
  lazy val parse_PAORES_IA_93_1: Parser[PAORES_IA_93_1] =
    log(parse_Segment__UNB.?)("(S) unb") ~
      ...
      log(parse_Segment_S_2.?)("(S) messageEntry") ~
      log(repMN(parse_Segment_S_1, 0, 2))("(S) freeflowText") ~
      log(repMN(parse_Group_G_1, 0, 5))("(G) errorOrWarningSection") ~
      log(repMN(parse_Group_G_2, 0, 2))("(G) singleCityPairInfo") ^^ {
  ...
  lazy val parse_Group_G_1: Parser[Group_G_1] =
    log(parse_Segment_S_3)("(S) errorOrWarningInfo") ~
      log(parse_Segment_S_1.?)("(S) textInformation") ^^ {
  ...
  lazy val parse_Group_G_2: Parser[Group_G_2] =
    log(parse_Segment_S_4)("(S) boardoff") ~
      log(repMN(parse_Group_G_3, 0, 99))("(G) flightInfo") ^^ {
  ...
  lazy val parse_Group_G_3: Parser[Group_G_3] =
    log(parse_Segment_S_8)("(S) basicFlightInfo") ~
      log(parse_Segment_S_6.?)("(S) infoOnClass") ~
      log(parse_Segment_S_5.?)("(S) flightDetails") ~
      log(parse_Segment_S_1.?)("(S) flightFreeflowText") ~
      log(parse_Segment_S_7.?)("(S) trafficRestrictionDetails") ~
      log(repMN(parse_Group_G_4, 0, 5))("(G) flightErrorWarningSection") ^^ {
  ...
  lazy val parse_Group_G_4: Parser[Group_G_4] =
    log(parse_Segment_S_3)("(S) flightErrorWarningInfo") ~
      log(parse_Segment_S_1.?)("(S) flightErrorWarningText") ^^ {
  ...
  lazy val parse_Segment_S_5: Parser[Segment_S_5] = "APD" ~>
    log((plus ~> parse_Composite_C_4).?)("(C) flightDetails") ~
    log((plus ~> parse_Composite_C_8).?)("(C) departureStation") ~
    log((plus ~> parse_Composite_C_8).?)("(C) arrivalStation") ~
    log((plus ~> parse_Composite_C_5).?)("(C) milageDetails") ~
    log((plus ~> parse_Composite_C_6).?)("(C) travellerTimeDetails") ~
    log((plus ~> parse_Composite_C_7).?)("(C) ") ~
    log((plus ~> parse_Composite_C_7).?)("(C) ") ~
    log(repMN((plus ~> parse_Composite_C_7.?), 0, 10))("(C) productFacilities") <~ quote ^^ {
  ...
  lazy val parse_Segment_S_3: Parser[Segment_S_3] = "ERC" ~>
    log((plus ~> parse_Composite_C_3))("(C) error") <~ quote ^^ {
    case error =>
      Segment_S_3(
        error
      )
  ...
  lazy val parse_Segment_S_1: Parser[Segment_S_1] = "IFT" ~>
    log((plus ~> parse_Composite_C_1).?)("(C) freeTextQualification") ~
  ...
  lazy val parse_Segment_S_2: Parser[Segment_S_2] = "MSG" ~>
    log((plus ~> parse_Composite_C_2))("(C) functionDetails") ~
  ...
  lazy val parse_Segment_S_4: Parser[Segment_S_4] = "ODI" ~>
  ...
  lazy val parse_Segment_S_6: Parser[Segment_S_6] = "PDI" ~>
    log((plus ~> parse_Data).?)("(D) ") ~
    log(repMN((plus ~> parse_Composite_C_9), 1, 26))("(C) productClassDetail") <~ quote ^^ {
  ...
  lazy val parse_Segment_S_7: Parser[Segment_S_7] = "TRF" ~>
    log(repMN((plus ~> parse_Composite_C_10.?), 0, 5))("(C) trafficRestriction") <~ quote ^^ {
  ...
  lazy val parse_Segment_S_8: Parser[Segment_S_8] = "TVL" ~>
    log((plus ~> parse_Composite_C_14))("(C) flightDate") ~
    log((plus ~> parse_Composite_C_15))("(C) boardPointDetails") ~
    log((plus ~> parse_Composite_C_15))("(C) offPointDetails") ~
    log((plus ~> parse_Composite_C_11).?)("(C) companyDetails") ~
    log((plus ~> parse_Composite_C_12))("(C) flightIdentification") ~
    log((plus ~> parse_Composite_C_13).?)("(C) flightTypeDetails") ~
  ...
  lazy val parse_Composite_C_2: Parser[Composite_C_2] =
  ...
  lazy val parse_Composite_C_9: Parser[Composite_C_9] =
  ...
  lazy val parse_Composite_C_11: Parser[Composite_C_11] =
  ...
  lazy val parse_Composite_C_12: Parser[Composite_C_12] =
  ...
  lazy val parse_Composite_C_13: Parser[Composite_C_13] =
  ...
  lazy val parse_Composite_C_14: Parser[Composite_C_14] =
  ...
  lazy val parse_Composite_C_4: Parser[Composite_C_4] =
  ...
  lazy val parse_Composite_C_5: Parser[Composite_C_5.type] = success(Composite_C_5)

  lazy val parse_Composite_C_6: Parser[Composite_C_6] =
  ...
  lazy val parse_Composite_C_7: Parser[Composite_C_7] =
    log(parse_Data.?)("(D) tpe") ^^ {
      case tpe =>
        Composite_C_7(
  ...
  lazy val parse_Composite_C_15: Parser[Composite_C_15] =
  ...
  lazy val parse_Composite_C_10: Parser[Composite_C_10] =
  ...
  lazy val parse_Composite_C_1: Parser[Composite_C_1] =
  ...
  lazy val parse_Composite_C_8: Parser[Composite_C_8] =
  ...
  lazy val parse_Composite_C_3: Parser[Composite_C_3] =
    log(parse_Data)("(D) code") ~
